...
import controller.ControllerMotocicleta;
 ...
 * @author 06607289150
 */
public class OperacaoMotocicleta extends javax.swing.JFrame {

    /**
     * Creates new form OperacaoCarro
     */
    public OperacaoMotocicleta() {
        initComponents();
    }
    ...
    private void btEnviar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEnviar1ActionPerformed
        ControllerMotocicleta cc = new ControllerMotocicleta();
        ...
        String msg = cc.RegistrarOperacaoMotocicleta(txtPatrimonio.getText(), 
            ...
            bagageiro, txtObjetivo.getText(),txtDataInicio.getText(),txtDataFim.getText(), txtHoraInicio.getText(),
            txtHoraFim.getText(), txtOcorrencia.getText());
        JOptionPane.showMessageDialog(null,msg); 
        /*
        String msg = cc.RegistrarOperacaoCarro(txtPatrimonio.getText(), 
            txtChassi.getText(), txtPlaca.getText(), txtCor.getText(), 
            txtMarca.getText(), txtModelo.getText(), ano,txtMotor.getText(),txtDestinacao.getText(),cbCombustivel.getSelectedItem().toString(), 
            nrPortas, blindagem, txtObjetivo.getText(),txtDataInicio.getText(),txtDataFim.getText(), txtHoraInicio.getText(),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OperacaoMotocicleta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OperacaoMotocicleta().setVisible(true);
            }
        });
    }
