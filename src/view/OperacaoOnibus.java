 ...
 * @author 06607289150
 */
public class OperacaoOnibus extends javax.swing.JFrame {

    /**
     * Creates new form OperacaoCarro
     */
    public OperacaoOnibus() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        cbTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Convencional", "Executivo", "Leito" }));
    ...
    private void btEnviar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEnviar1ActionPerformed
        ControllerOnibus cc = new ControllerOnibus();
        ...
        String msg = cc.RegistrarOperacaoOnibus(txtPatrimonio.getText(), 
            ...
            cbTipo.getSelectedItem().toString(), blindagem, txtObjetivo.getText(),txtDataInicio.getText(),txtDataFim.getText(), txtHoraInicio.getText(),
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OperacaoOnibus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OperacaoOnibus().setVisible(true);
            }
        });
    }
